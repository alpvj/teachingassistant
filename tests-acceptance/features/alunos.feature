...
Scenario: Removing students with registered CPF
Given I am at the students page
And I can see "Mari" with CPF "683" in the students list
When I try to remove the student "Mari" with CPF "683"
Then I can not see "Mari" with CPF "683" in the students list